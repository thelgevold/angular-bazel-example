...
@NgModule({
    imports: [Module_joystick_team0,Module_joystick_team1,Module_joystick_team2,Module_joystick_team3,Module_joystick_team4,Module_joystick_team5,Module_joystick_team6,Module_joystick_team7,Module_joystick_team8,Module_joystick_team9],
})
