...
@NgModule({
    imports: [Module_airplane_team0,Module_airplane_team1,Module_airplane_team2,Module_airplane_team3,Module_airplane_team4,Module_airplane_team5,Module_airplane_team6,Module_airplane_team7,Module_airplane_team8,Module_airplane_team9],
})
